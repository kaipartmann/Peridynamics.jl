...
and the number of spatial dimensions `N` of the simulation, or `Nothing` for a model without
state. This method is generated by [`@cm_storage`](@ref) and is the constitutive-model
analogue of [`storage_type`](@ref).
"""
