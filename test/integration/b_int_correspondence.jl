...
@testitem "Internal force density correspondence rotated" begin
    ...
    # this is different due to changed bc
    @test_broken b_int[:,1] ≈ [0.0, 1.1846541080217141e-14, 1.59116313101076e-14]
    @test_broken b_int[:,2] ≈ [-9.81399596527191e-15, 1.0619791584558151e-14, 1.3915198328621624e-14]
    @test_broken b_int[:,3] ≈ [4.8349988789970084e-15, -2.3693082160434282e-14, -1.2267494956589887e-15]
    @test_broken b_int[:,4] ≈ [4.978997086274901e-15, 1.2267494956589887e-15, -2.8600080143070235e-14]
    @test b_int[:,5] ≈ [0.0, 0.0, 0.0]
end
