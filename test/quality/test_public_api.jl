...
@testmodule APISnapshot begin
    ...
    const PUBLIC = [
        ...
        "BBStorage", "Bond", "BondField", "BondFracFields", "BondFracState",
        ...
        "block_table", "bond_integrity", "bond_is_active", "bond_stretch", "break_bond!",
        "break_bonds!", "calc_damage!", "calc_failure!",
