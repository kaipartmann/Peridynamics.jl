@testitem "uniform_box" begin
    ...
    pos, vol = uniform_box(1, 1, 1, 0.5; center=(1, 1, 1))
    @test pos == [
...
@testitem "uniform_sphere" begin
    ...
    pos, vol = uniform_sphere(1, 0.5; center=(1, 1, 1))
    @test pos == [
        0.75  1.25  0.75  1.25  0.75  1.25  0.75  1.25
        0.75  0.75  1.25  1.25  0.75  0.75  1.25  1.25
        0.75  0.75  0.75  0.75  1.25  1.25  1.25  1.25
...
@testitem "uniform_cylinder" begin
    pos, vol = uniform_cylinder(1, 2, 0.5)
    @test pos ≈ [
    ...
    pos, vol = uniform_cylinder(1, 2, 0.5; center=(1, 2, 1))
    @test pos ≈ [
...
@testitem "round_sphere" begin
    ...
    pos, vol = round_sphere(0.2, 0.5)
    @test pos ≈ [
        0.0
        0.0
        0.0
    ]
    @test vol == fill(0.004188790204786391, 1)

    pos, vol = round_sphere(2.1, 1.0)
    @test pos ≈ [
        0.3175426480542942 -0.3175426480542942 -0.3175426480542942 0.3175426480542942;
        0.3175426480542942 -0.3175426480542942 0.3175426480542942 -0.3175426480542942;
        0.3175426480542942 0.3175426480542942 -0.3175426480542942 -0.3175426480542942
    ]
    @test vol == fill(1.2122620652039615, 4)

    pos, vol = round_sphere(1.8, 1.0)
    @test pos ≈ [
        -0.4  0.4
         0.0  0.0
         0.0  0.0
        ]
    @test vol == fill(1.5268140296446395, 2)

    pos, vol = round_sphere(1.6, 0.5; center=(1, 2, 3))
    @test pos ≈ [
    ...
    pos, vol = round_sphere(1, 0.5; center=(1, 2, 3))
    @test pos ≈ [
        1.25 0.875 0.875;
...
@testitem "trunc_pyramid" begin
    pos, vol = trunc_pyramid(4, 5, 3, 2)
    @test isapprox(pos,  [
        -0.75     -0.75     -0.75     -0.75      1.4375     1.4375     1.4375    1.4375;
        -1.09375   1.09375  -1.09375   1.09375  -0.820312   0.820312  -0.820312  0.820312;
        -1.09375  -1.09375   1.09375   1.09375  -0.820312  -0.820312   0.820312  0.820312
    ], atol=1e-5)
    @test isapprox(vol, [
        10.46753
    ...
    pos, vol = trunc_pyramid(4, 5, 3, 2, center=(1, 2, 3))
    @test isapprox(pos,  [
        -0.75     -0.75     -0.75     -0.75      1.4375     1.4375     1.4375    1.4375;
        -1.09375   1.09375  -1.09375   1.09375  -0.820312   0.820312  -0.820312  0.820312;
        -1.09375  -1.09375   1.09375   1.09375  -0.820312  -0.820312   0.820312  0.820312
...
@testitem "rotate!" begin
    ...
    @test pos ≈ [
        ...
        -transpose(pos_center[3,:]);
        transpose(pos_center[2,:]);
    ]
    @test vol == fill(0.20943951023931953, 15)
    ...
    pos45 = [
       -0.25       0.25      -0.25      0.25      -0.25       0.25      -0.25      0.25
        0.0        0.0        0.353553  0.353553  -0.353553  -0.353553   0.0       0.0
       -0.353553  -0.353553   0.0       0.0        0.0        0.0        0.353553  0.353553
    ]
    @test isapprox(pos, pos45; atol=0.000002)
end
