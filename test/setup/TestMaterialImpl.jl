...
# registers them with the package. Use it with `setup=[TestMaterialImpl]` and the qualified names
# `TestMaterialImpl.TestMaterial`, `TestMaterialImpl.TestStorage`, ...
@testmodule TestMaterialImpl begin
    using Peridynamics
